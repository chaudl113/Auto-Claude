...
export type AppSection = 'appearance' | 'display' | 'language' | 'agent' | 'paths' | 'integrations' | 'performance' | 'updates' | 'notifications';
...
export function AppSettingsDialog({ open, onOpenChange, initialSection, initialProjectSection, onRerunWizard }: AppSettingsDialogProps) {
  ...
  const renderAppSection = () => {
    switch (appSection) {
      ...
      case 'performance':
        return <PerformanceSettings settings={settings} onSettingsChange={setSettings} />;
      case 'updates':
